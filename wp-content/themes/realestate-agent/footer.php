        ...
        <p class="mb-0 py-3 text-center">
          <?php
            if (!get_theme_mod('realestate_agent_footer_text') ) { ?>
              ...
              <?php esc_html_e('Realestate Agent WordPress Theme','realestate-agent'); ?></a>
            <?php } else {
          ...
          <?php if ( get_theme_mod('realestate_agent_copyright_enable', true) == true ) : ?>
            ...
            <a href="<?php echo esc_url('https://wordpress.org'); ?>" rel="generator"><?php  /* translators: %s: WordPress */  printf( esc_html__( ' | Proudly powered by %s', 'realestate-agent' ), 'WordPress' ); ?></a>
          <?php endif; ?>
        </p>
      </div>
    </div>
